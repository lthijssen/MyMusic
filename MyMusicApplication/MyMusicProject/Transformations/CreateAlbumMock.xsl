   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="createAlbumRequest" namespace="http://www.undertheredcloud.org/api/mymusic"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            <oracle-xsl-mapper:schema location="../Schemas/MyMusic.xsd"/>
            <oracle-xsl-mapper:rootElement name="createAlbumResponse" namespace="http://www.undertheredcloud.org/api/mymusic"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [THU MAR 08 15:02:58 CET 2018].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <ns0:createAlbumResponse>
         <ns0:albums>
            <ns0:id>
               <xsl:value-of select="/ns0:createAlbumRequest/ns0:albums/ns0:id"/>
            </ns0:id>
            <ns0:artist>
               <xsl:value-of select="/ns0:createAlbumRequest/ns0:albums/ns0:artist"/>
            </ns0:artist>
            <ns0:title>
               <xsl:value-of select="/ns0:createAlbumRequest/ns0:albums/ns0:title"/>
            </ns0:title>
            <ns0:year>
               <xsl:value-of select="/ns0:createAlbumRequest/ns0:albums/ns0:year"/>
            </ns0:year>
            <ns0:genre>
               <xsl:value-of select="/ns0:createAlbumRequest/ns0:albums/ns0:genre"/>
            </ns0:genre>
         </ns0:albums>
      </ns0:createAlbumResponse>
   </xsl:template>
