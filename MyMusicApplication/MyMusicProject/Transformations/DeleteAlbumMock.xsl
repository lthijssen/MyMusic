   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="deleteAlbumRequest" namespace="http://www.undertheredcloud.org/api/mymusic"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            <oracle-xsl-mapper:schema location="../Schemas/MyMusic.xsd"/>
            <oracle-xsl-mapper:rootElement name="deleteAlbumResponse" namespace="http://www.undertheredcloud.org/api/mymusic"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [THU MAR 08 15:07:14 CET 2018].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <ns0:deleteAlbumResponse>
         <ns0:result>
           <xsl:value-of select="concat('Album with ID ', /ns0:deleteAlbumRequest/ns0:id, ' has been removed.')"/>
        </ns0:result>
      </ns0:deleteAlbumResponse>
   </xsl:template>
</xsl:stylesheet>
